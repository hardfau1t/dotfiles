...
mod.setup = function(client, bufnr)
    ...
    vim.keymap.set('n', "<leader>do", function() vim.diagnostic.open_float() end, { buffer = bufnr , desc = "open diagnostic message in floating window"})
    vim.keymap.set('n', "<leader>dp", function() vim.diagnostic.goto_prev() end, { buffer = bufnr , desc = "previous diagnostics"})
    vim.keymap.set('n', "<leader>dn", function() vim.diagnostic.goto_next() end, { buffer = bufnr , desc = "next diagnostics"})
    vim.keymap.set('n', "<leader>ds", function() vim.diagnostic.show() end, { buffer = bufnr , desc = "show all diagnostic errors"})
    vim.keymap.set('n', "<leader>dh", function() vim.diagnostic.hide() end, { buffer = bufnr , desc = "hide all diagnostic errors"})
    vim.keymap.set('n', "<leader>dd", function() vim.diagnostic.disable() end, { buffer = bufnr , desc = "disable lsp diagnostics"})
    vim.keymap.set('n', "<leader>de", function() vim.diagnostic.enable() end, { buffer = bufnr, desc = "enable lsp diagnostics"})
    vim.keymap.set('n', "<leader>dq", function() vim.diagnostic.toqflist() end, { buffer = bufnr , desc = "move diagnostics to quickfixlist"})
